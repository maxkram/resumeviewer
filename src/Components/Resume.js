...
class Resume extends Component {
  render() {
    return (
      ...
      <div classNameName="row education">

         <div classNameName="three columns header-col">
            <h1><span>Education</span></h1>
         </div>

         <div classNameName="nine columns main-col">

            <div classNameName="row item">

               <div classNameName="twelve columns">

                  <h3>University of Life</h3>
                  <p classNameName="info">Master in Graphic Design <span>&bull;</span> <em classNameName="date">April 2007</em></p>
            ...
            <div classNameName="row item">
               ...
               <div classNameName="twelve columns">
                  ...
                  <p classNameName="info">B.A. Degree in Graphic Design <span>&bull;</span> <em classNameName="date">March 2003</em></p>
